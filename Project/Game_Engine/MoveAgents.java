            ...
            new Thread(() -> {
                ...
                try {
                    ...
                    if (truck.getMovable()) {
                        ...
                        switch(searchType) {
                            case "breadthFirstSearch" : waitTime = 500; BreadthFirstSearch bfs = new BreadthFirstSearch(environment); goalNode = bfs.search(rootNode); break;
                            case "depthFirstSearch" : waitTime = 200; DepthFirstSearch dfs = new DepthFirstSearch(environment); goalNode = dfs.search(rootNode); break;
                            default : break;
                        }
