...
public interface Constants {
    ...
    //add path cost of parent to new step cost to get new path cost
    int GO_FORWARD_STEP_COST = 1;
    int TURN_RIGHT_STEP_COST = 1;
    int TURN_LEFT_STEP_COST = 1;

    default TruckAgent build(double width, double height, Location location, TruckAgent truck) {
        ...
        //UUID updated
        //Don't create new truck, update old one
