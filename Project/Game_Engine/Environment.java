    ...
    public TruckAgent [] fillAgents(int numAgents, int numObstacles) {
        ...
        for(int i = 0; i < agents.length; i++) {
            ...
            for(int j = 0; j < agents[i].length; j++) {
                ...
                Cell cell = new Cell(new Location(i, j), widthOfCell, heightOfCell, "null", 1);
                this.add(cell, j, i);
                cells[i][j] = cell;
            }
        }
    ...
    private void createObstacles(int numOfObstacles) {
        ...
        while(count < numOfObstacles) {
            ...
            if(cells[i][j].getPassable()) {
                ...
                Cell cell = new Cell(new Location(i, j), widthOfCell, heightOfCell, NON_PASSABLE, 1);
    ...
    public void createGoals(int numGoals) {
        ...
        while(count < numGoals) {
            ...
            if(cells[i][j].getPassable()) {
                ...
                Cell cell = new Cell(location, widthOfCell, heightOfCell, GOAL_CELL, 1);
