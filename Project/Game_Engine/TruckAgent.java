...
public class TruckAgent extends Group implements Constants {
    ...
    public boolean goForward(Environment environment) {
        ...
        if(getDirection() == FACING_SOUTH)
            shiftXValue = MOVING_SOUTH;
        else if(getDirection() == FACING_WEST)
            shiftYValue = MOVING_WEST;
        else if(getDirection() == FACING_NORTH)
    ...
    public String toString() {
        ...
        return "OldWork.Distributed_Tic_Tac_Toe_Games.Agent ID: " + getUUID() + ", x = " + getLocation().getX() + ", y = " + getLocation().getY();
    }
}