...
public class DepthLimitedSearch implements Constants {
    ...
    public Node search(Node rootNode, int maxStep, long maxTime) throws CloneNotSupportedException {
        ...
        while(!fringe.isEmpty()) {
            ...
            if(currentNode.getActionsList().size() < maxStep && !isDuplicateNode(currentNode)) {
