...
public class MoveAgentsSituation1 implements Action, Constants {
    ...
    public MoveAgentsSituation1(Environment environment, String searchType, int maxStep, long maxTime) {

        this.environment = environment;
        agents = environment.fillCellsSituation1();
        environment.createGoalsSituation1();
