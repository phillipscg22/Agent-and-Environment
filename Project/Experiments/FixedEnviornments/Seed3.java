...
import Project.Experiments.SeedGeneration.Seed3Build;
import Project.Game_Engine.*;
import Project.Infrastructure.Node;
import javafx.application.Platform;

public class Seed3 implements Action, Constants {
    ...
    public Seed3(Environment environment, String searchType, int maxStep, long maxTime) {

        this.environment = environment;
        agents = Seed3Build.fillCellsSituation(environment);
        Seed3Build.createGoalsSituation(environment);
