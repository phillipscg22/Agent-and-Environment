...
public class MoveAgentsSituation2 implements Action, Constants {
    ...
    public MoveAgentsSituation2(Environment environment, String searchType, int maxStep, long maxTime) {

        this.environment = environment;
        agents = environment.fillCellsSituation2();
        environment.createGoalsSituation2();
