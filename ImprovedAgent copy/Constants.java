...
public interface Constants {
    ...
    public final int FACING_SOUTH = 0;
    public final int FACING_WEST = 1;
    public final int FACING_NORTH = 2;
    public final int FACING_EAST = 3;

    public default TruckAgent build(double width, double height, Location location) {
        ...
        TruckAgent truck = new TruckAgent(true, false, true, location);
